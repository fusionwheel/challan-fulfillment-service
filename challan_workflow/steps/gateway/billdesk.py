...
class BillDeskSDKPaymentPage(BasePage):
    ...
    def get_bank_name(self):
        print("self.is_corporate", self.is_corporate)
        print("self.bank_name", self.bank_name)
        return self.bank_name + (" [Corporate]" if self.is_corporate else " [Retail]")
    ...
    def select_bank_by_name(self):
        ...
        """ 
        bank_display_name = self.get_bank_name()
...
class BillDeskSDKRetailPaymentPage(BillDeskSDKPaymentPage):
    bank_name = "ICICI Bank"
    is_corporate = False
