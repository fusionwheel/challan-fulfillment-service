...
from challan_workflow.steps.egras.WB import WBGRIPSPaymentPage
...
from challan_workflow.steps.egras.WB import WBGRIPSPostPaymentSuccessRedirectPage
from challan_workflow.steps.receipt.download import DownloadReceiptPage

class WBWorkflow(BaseWorkflow):
    steps = [
        GoTOeChallanPage,
        ...
        WBGRIPSPostPaymentSuccessRedirectPage,
        DownloadReceiptPage
    ]